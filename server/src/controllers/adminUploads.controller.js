...
const storageDriver = String(process.env.UPLOAD_STORAGE || "local").toLowerCase();
const cloudinaryFolder = String(process.env.CLOUDINARY_FOLDER || "apsara-style/products");
