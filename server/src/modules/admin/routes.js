...
const adminProductsController = require("../adminProducts/controller");
const adminOrdersController = require("../adminOrders/controller");
const adminReturnsController = require("../adminReturns/controller");
const adminUploadsController = require("../adminUploads/controller");
